...
import { ShoppingCart, Trash2, Plus, Minus, ArrowLeft, Check, User, Phone, Key, Lock, AlertCircle, UserCircle } from "lucide-react";
                      ...
                      <div className="mb-4 space-y-2">
                        <div className="p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg flex items-center gap-2">
                          ...
                          <p className="text-xs text-amber-300">
                            Connecté en tant que <span className="font-bold">{user.username}</span> — votre ID unique est pré-rempli automatiquement.
                          </p>
                        </div>
                        {hasProfileData && (
                          <div className="p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg flex items-start gap-2">
                            <UserCircle className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" />
                            <p className="text-xs text-blue-300">
                              Les champs pré-remplis depuis votre profil sont verrouillés. Modifiez-les dans{" "}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          readOnly={isLoggedIn}
                          className={`bg-gray-800 border-gray-700 text-white placeholder:text-gray-500 focus:border-amber-500 font-mono ${
