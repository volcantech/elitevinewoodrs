...
import { Search, Car, ShoppingCart, Users, Shield, Megaphone, ChevronLeft, ChevronRight, Loader2, Lock, EyeOff, Eye, BarChart2, Star, Webhook } from "lucide-react";
          ...
          <>
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              <TabsList className="bg-slate-800/50 border border-amber-600/30">
                ...
                {(currentUser?.permissions?.webhooks?.manage || currentUser?.permissions?.loyalty?.manage) && (
                  <TabsTrigger
                    value="webhooks"
                    className="data-[state=active]:bg-amber-500 data-[state=active]:text-black"
                  >
