...
import { Search, Car, ShoppingCart, Users, Shield, Megaphone, ChevronLeft, ChevronRight, FileText } from "lucide-react";
...
export default function Admin() {
  ...
  const fetchCategories = async (_authToken: string) => {
    try {
      ...
      const mergedCategories = [...new Set([...CATEGORIES, ...data])].sort();
