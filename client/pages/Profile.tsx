...
export default function Profile() {
  ...
  const { user, friendCount, lastLogin, lastSeen, earnedBadges: earnedBadgesRaw, earnedCustomBadges, favoriteVehicles, isOnline, friendshipStatus, friendshipRequester, iBlockedThem } = profile;
