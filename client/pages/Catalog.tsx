  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative bg-gradient-to-br from-amber-950/40 via-black to-blue-950/40 py-20 px-4 sm:px-6 lg:px-8 border-b border-amber-500/20 overflow-hidden">
        ...
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-amber-500/20 rounded-full blur-3xl opacity-50"></div>
        <div 
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-orange-500/20 rounded-full blur-3xl opacity-50"
        ></div>
