...
export default function Catalog() {
  ...
  const filteredVehicles = useMemo(() => {
    ...
    return sorted;
  }, [vehicles, selectedCategory, searchQuery, minWeight, minBudget, maxBudget, selectedSeats, selectedParticularity, selectedManufacturer, sortBy, showFavoritesOnly, favorites]);
