...
import {
  ...
  Lock, Shield, ShieldOff, Zap, Plus, Ticket, Clock, AlertTriangle, Award, UserX,
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-semibold text-gray-300 mb-3 flex items-center gap-2">
                    <Users className="w-4 h-4 text-amber-400" /> Mes amis ({friends.length})
                  </h3>
                  {friends.length === 0 ? (
                        ...
                        <div key={friend.id} className="flex items-center gap-3 p-3 bg-slate-800/40 rounded-xl border border-gray-700/50">
                          <button onClick={() => navigate(`/profile/${friend.id}`)}>
                            <div className="w-10 h-10 rounded-full bg-amber-500/20 border border-amber-500/30 flex items-center justify-center overflow-hidden shrink-0">
                              {friend.avatar_url ? (
                                ...
                                <span className="font-bold text-amber-400 text-sm">{friend.username[0]?.toUpperCase()}</span>
                              )}
                            </div>
                          </button>
                          <div className="flex-1 min-w-0">
                            <button onClick={() => navigate(`/profile/${friend.id}`)} className="text-sm font-semibold text-white hover:text-amber-300 transition-colors truncate block text-left">
                              {friend.username}
                            </button>
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="p-2 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/20 text-amber-400 transition-colors"
                ...
                {blockedUsers.length > 0 && (
                  <div>
                    <h3 className="text-sm font-semibold text-gray-300 mb-3 flex items-center gap-2">
                      <Shield className="w-4 h-4 text-orange-400" /> Utilisateurs bloqués ({blockedUsers.length})
                    </h3>
                    <div className="space-y-2">
                        ...
                        <div key={u.id} className="flex items-center gap-3 p-3 bg-slate-800/40 rounded-xl border border-orange-500/10">
                          <div className="w-9 h-9 rounded-full bg-orange-500/10 border border-orange-500/20 flex items-center justify-center shrink-0">
                            {u.avatar_url ? (
                              ...
                              <span className="font-bold text-orange-400 text-sm">{u.username[0]?.toUpperCase()}</span>
                            )}
                          </div>
                          <div className="flex-1 min-w-0">
