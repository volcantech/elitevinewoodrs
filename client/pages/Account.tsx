    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <Tabs defaultValue="profile">
          <TabsList className="bg-gray-900 border border-gray-700 w-full mb-6 grid grid-cols-3">
            <TabsTrigger value="profile" className="flex-1 data-[state=active]:bg-amber-500 data-[state=active]:text-black">
              <UserCircle className="w-4 h-4 mr-2" />
              Mon profil
              {!profileComplete && (
                <span className="ml-2 w-2 h-2 rounded-full bg-orange-400 animate-pulse" />
              )}
            </TabsTrigger>
            <TabsTrigger value="orders" className="flex-1 data-[state=active]:bg-amber-500 data-[state=active]:text-black">
              ...
              Commandes
              {orders.length > 0 && (
                <span className="ml-2 bg-amber-500/20 text-amber-300 text-xs px-1.5 py-0.5 rounded-full">
                  {orders.length}
                </span>
              )}
            </TabsTrigger>
