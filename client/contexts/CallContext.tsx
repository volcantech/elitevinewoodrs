...
export function CallProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <CallContext.Provider value={{ callState, callPartner, callDuration, isMuted, isScreenSharing, remoteScreenStream, localStream, remoteStream, initiateCall, acceptIncomingCall, rejectIncomingCall, endCall, toggleMute, toggleScreenShare }}>
      {children}
