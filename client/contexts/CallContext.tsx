...
export function CallProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <CallContext.Provider value={{ callState, callPartner, callDuration, isMuted, isScreenSharing, remoteScreenStream, initiateCall, acceptIncomingCall, rejectIncomingCall, endCall, toggleMute, toggleScreenShare }}>
      {children}
