      ...
      ws.onmessage = (event) => {
        try {
          ...
          if (data.type === "chat_message") {
            window.dispatchEvent(new CustomEvent("admin-chat-message", { detail: data }));
            return;
          }
          if (data.type === "chat_session_new" || data.type === "chat_new_session") {
            window.dispatchEvent(new CustomEvent("admin-chat-session-new", { detail: data }));
            return;
          }
          if (data.type === "chat_session_closed") {
            window.dispatchEvent(new CustomEvent("admin-chat-session-closed", { detail: data }));
            return;
          }
