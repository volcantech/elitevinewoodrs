...
export function GlobalCallBar() {
  const { callState, callPartner, callDuration, isMuted, isScreenSharing, remoteScreenStream, acceptIncomingCall, rejectIncomingCall, endCall, toggleMute, toggleScreenShare } = useCallContext();
