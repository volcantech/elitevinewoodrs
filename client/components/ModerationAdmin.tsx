...
import { Shield, Plus, Trash2, RefreshCw, AlertTriangle, FileText, ChevronRight, ChevronLeft, Eye } from "lucide-react";
                          ...
                          {filteredLogs.map((log) => (
                            <TableRow key={log.id} className="border-amber-600/20 hover:bg-slate-800/50">
                              ...
                              <TableCell className="text-center">
                                <ActivityLogDetailsDialog details={log.details} trigger={<Button variant="ghost" size="icon" className="h-8 w-8 text-amber-400 hover:text-amber-300 hover:bg-amber-500/10"><Eye className="h-4 w-4" /></Button>} />
                              </TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
