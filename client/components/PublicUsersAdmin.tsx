...
import {
  ...
  Pencil, Eye, EyeOff, Lock, MoreVertical, History, Star, Package, ChevronLeft, ChevronRight, Gift, Wifi,
} from "lucide-react";
...
const DEFAULT_PERMISSIONS: UserPermissions = {
  ...
  moderation: { view: false, ban_uniqueids: false, view_logs: false, ban_players: false },
        ...
        <DialogContent className="bg-slate-900 border-purple-600/30 text-white max-w-2xl max-h-[80vh] flex flex-col">
          ...
          {historyLoading ? (
            ...
            <Tabs defaultValue="reviews" className="flex-1 flex flex-col min-h-0">
              <TabsList className="bg-slate-800 border border-gray-700 w-full grid grid-cols-2 shrink-0">
