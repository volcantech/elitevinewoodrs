...
export function PublicUsersAdmin({ token, currentUser, permissions }: PublicUsersAdminProps) {
  ...
  const [actionsForm, setActionsForm] = useState({ is_orders_blocked: false, is_reviews_blocked: false, is_messages_blocked: false, is_calls_blocked: false, unique_id: "", rp_phone: "", rp_firstname: "", rp_lastname: "", clear_avatar: false, clear_banner: false });
            ...
            <div className="bg-slate-800/40 rounded-xl p-4 border border-gray-700/50">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                <div
                  ...
                  onClick={() => setActionsForm((f) => ({ ...f, is_messages_blocked: !f.is_messages_blocked }))}
                >
                  <div className="flex-1 mr-2">
                    <p className={`text-sm font-medium ${actionsForm.is_messages_blocked ? "text-orange-300" : "text-gray-300"}`}>Messages</p>
                  </div>
                  <div onClick={(e) => e.stopPropagation()}>
                    <Switch checked={actionsForm.is_messages_blocked} onCheckedChange={(v) => setActionsForm((f) => ({ ...f, is_messages_blocked: v }))} />
                  </div>
                </div>
                <div
                  className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-all ${
