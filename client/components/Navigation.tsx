...
import { Car, User, LogOut, ChevronDown, Shield, Bell, Trash2 } from "lucide-react";
                              ...
                              {bellNotifs.map((n) => (
                                <div key={n.id} className="flex items-start gap-3 px-4 py-3 hover:bg-gray-800/50 transition-colors">
                                  <span className="text-base shrink-0 mt-0.5">
                                    {n.type === "delivered" ? "📦" : n.type === "cancelled" ? "❌" : "💬"}
                                  </span>
                                  <div className="flex-1 min-w-0">
                                    <p className={`text-xs font-semibold ${n.type === "delivered" ? "text-green-300" : n.type === "cancelled" ? "text-red-300" : "text-blue-300"}`}>
                                      {n.title}
                                    </p>
