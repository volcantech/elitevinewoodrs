...
import { Loader2, Star, Gift, History, ChevronDown, ChevronUp, Search, ChevronLeft, ChevronRight, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-slate-900/50 border border-amber-600/20 rounded-xl p-4">
        ...
        <p className="text-xs text-gray-500 mt-2">Attribution : 5 pts / 250 000$ livré — remises appliquées par le patron uniquement</p>
      </div>
