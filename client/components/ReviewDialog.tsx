              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    maxLength={50}
                    className="w-full bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500/30"
                  />
                </div>
                <div>
            ...
            <div className="space-y-3">
              {data.reviews.map((review) => (
                ...
                >
                  ...
                  {review.comment && (
                    <p className="text-sm text-gray-300 mt-1 leading-relaxed pl-8">
                      {review.comment}
                    </p>
                  )}
                </div>
