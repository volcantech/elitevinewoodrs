        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              <TableRow><TableCell colSpan={4} className="text-center py-8 text-gray-400">Aucune catégorie</TableCell></TableRow>
            ) : (
              categories.map((cat) => (
                <TableRow key={cat.id || cat.name} className="border-amber-600/20 hover:bg-slate-800/50">
                  ...
                  <TableCell className="text-gray-500 text-xs">#{cat.id || '?'}</TableCell>
