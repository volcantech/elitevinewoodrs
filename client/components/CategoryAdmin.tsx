    ...
    <div className="space-y-6">
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="bg-slate-900 border-amber-600/30 text-white">
          ...
          <DialogFooter>
            <Button onClick={handleAddCategory} className="bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white font-semibold">Ajouter</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={!!editingCategory} onOpenChange={(open) => !open && setEditingCategory(null)}>
        <DialogContent className="bg-slate-900 border-amber-600/30 text-white">
          ...
          <DialogFooter>
            <Button onClick={handleUpdateCategory} className="bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white font-semibold">Enregistrer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
