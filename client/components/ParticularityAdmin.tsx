    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button onClick={() => setIsAddDialogOpen(true)} className="bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white font-semibold shadow-lg shadow-amber-900/20">
            <Plus className="h-4 w-4 mr-2" /> Ajouter une particularité
          </Button>
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="bg-slate-900 border-amber-600/30 text-white">
          ...
          <DialogFooter>
            <Button onClick={handleAdd} className="bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white font-semibold">Ajouter</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={!!editingParticularity} onOpenChange={(open) => !open && setEditingParticularity(null)}>
        <DialogContent className="bg-slate-900 border-amber-600/30 text-white">
          ...
          <DialogFooter>
            <Button onClick={handleUpdate} className="bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white font-semibold">Enregistrer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
