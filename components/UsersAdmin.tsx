              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-gray-700">
                    <TableHead className="text-gray-300">Pseudonyme / ID unique</TableHead>
                  ...
                  {users.map((user) => (
                    <TableRow key={user.id} className="border-gray-700 hover:bg-slate-800/50">
                      <TableCell className="font-medium">
                        {user.username}
                        {user.unique_id && (
                          <Badge className="ml-2 bg-amber-500/20 text-amber-300 text-xs">({user.unique_id})</Badge>
                        )}
                        {user.id === currentUser?.id && !user.unique_id && (
