...
export function createServer() {
  ...
  app.patch("/api/admin/spreadsheets/:id/pagination", adminAuth, requirePermission("spreadsheets", "edit"), mutationLimiter, updateSpreadsheetPagination);
