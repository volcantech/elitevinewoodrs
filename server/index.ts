...
export function createServer() {
  ...
  app.post("/api/admin/spreadsheets/:id/rows", adminAuth, requirePermission("spreadsheets", "edit"), mutationLimiter, upsertRow);
  app.post("/api/admin/spreadsheets/:id/rows/reorder", adminAuth, requirePermission("spreadsheets", "edit"), mutationLimiter, reorderSpreadsheetRows);
