      ...
      for (const [key, value] of Object.entries(variables)) {
        ...
        content = content.replace(
          ...
          (match) => {
            ...
            // All other variables: insert in Arial 11pt for consistent document styling
            return `<span style="font-family:Arial,sans-serif;font-size:11pt;">${String(value)}</span>`;
          }
        );
      }
    }
