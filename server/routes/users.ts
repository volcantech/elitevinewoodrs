...
export async function initUsersTable() {
  try {
    ...
    // Error logged Erreur lors de l'initialisation de la table admin_users :", error);
  }
}
...
export async function getAllUsers(req: Request, res: Response) {
  try {
    ...
    // Error logged Erreur lors de la récupération des utilisateurs :", error);
...
export async function getUserById(req: Request, res: Response) {
  ...
  try {
    ...
    // Error logged Erreur lors de la récupération d'un utilisateur :", error);
...
export async function createUser(req: Request, res: Response) {
  ...
  try {
    ...
    // Error logged Erreur lors de la création d'un utilisateur :", error);
...
export async function updateUser(req: Request, res: Response) {
  ...
  try {
    ...
    // Error logged Erreur lors de la mise à jour d'un utilisateur :", error);
...
export async function deleteUser(req: Request, res: Response) {
  ...
  try {
    ...
    // Error logged Erreur lors de la suppression d'un utilisateur :", error);
