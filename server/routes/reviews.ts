...
export async function deleteReview(req: Request, res: Response) {
  try {
    ...
    await logActivity(
      ...
      {
        pseudo: { old: deletedReview.pseudo ?? null, new: null },
        véhicule: { old: deletedReview.vehicle_name ?? null, new: null },
        commentaire: { old: deletedReview.comment ?? null, new: null },
        reviewId: { old: reviewId, new: null },
      },
      null,
      req.ip ?? null
    );
...
export async function createReview(req: Request, res: Response) {
  try {
    ...
    await logActivity(
      ...
      { pseudo: cleanPseudo, vehicleId: parsedVehicleId, vehicleName, rating: parsedRating, comment: cleanComment },
      null,
      req.ip ?? null
    );
