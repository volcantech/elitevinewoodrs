...
export async function initAnnouncementsTable() {
  try {
    ...
    // Error logged Erreur lors de l'initialisation de la table announcements :", error);
  }
}
...
export async function getAnnouncement(req: Request, res: Response) {
  try {
    ...
    // Error logged Erreur lors de la récupération de l'annonce :", error);
...
export async function updateAnnouncement(req: Request, res: Response) {
  ...
  try {
    ...
    // Error logged Erreur lors de la mise à jour de l'annonce :", error);
