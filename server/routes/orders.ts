...
export async function initOrdersTables() {
  try {
    ...
    // Error loggedError initializing orders tables:", error);
  }
}
  ...
  try {
    ...
    if (webhookUrl) {
      try {
        ...
        // Error logged Échec de l'envoi du webhook :", webhookError);
      }
    }
    ...
    if (discordWebhookUrl) {
      try {
        ...
        // Error logged Échec de l'envoi du webhook Discord :", discordError);
      }
    }
    ...
    // Error logged Erreur lors de la création de la commande :", error);
...
export async function getAllOrders(req: Request, res: Response) {
  try {
    ...
    // Error logged Erreur récupération commandes :", error);
...
export async function getOrderById(req: Request, res: Response) {
  try {
    ...
    // Error logged Erreur lors de la récupération de la commande :", error);
  ...
  try {
    ...
    if (webhookUrl) {
      try {
        ...
        // Error logged Échec de l'envoi du webhook de statut :", webhookError);
      }
    }
    ...
    // Error logged Erreur lors de la mise à jour du statut de la commande :", error);
...
export async function deleteOrder(req: Request, res: Response) {
  try {
    ...
    // Error logged Erreur lors de la suppression d'une commande :", error);
